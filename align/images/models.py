...
stage = {0:'failed (check settings and restart)',1:'preprocessing', 1001:'preprocessing image stack', 2:'initial alignment', 1002:'calculating initial alignment', 3:'affine alignment', 1003:'processing affine alignment', 4:'final warp alignment', 1004:'processing warp alignment', 5:'checking alignment', 1005:'aligning BG channel', 6: 'aligning other channels', 1006:'aligning all channel using BG warp', 7:'alignment done', 10:'request merged tif',  1010:'creating merged tif', 20:'merged tif created', 2001:'paused before preprocessing', 2002:'paused before initial alignment', 2003:'paused before affine alignment', 2004:'paused before warp alignment', 2005:'paused before BG alignment', 2006:'paused before SG alignment' }
comp = {0:'awaiting processing',1:'convertion complete', 2:'preprocessing complete', 3:'initial alignment complete', 4:'affine alignment complete', 5:'final warp complete', 6: 'background alignment complete', 7: 'all channels aligned', 10: 'merged tif requested', 11: 'show in VFB', 20: 'merged tif created', 21: 'show in VFB'}
...
class Mask_original(models.Model):
    ...
    def mask_image(self):
      if self.complete:
        return '<img src="/images/nrrd/mask_original/%s"/>' % str(self.image.id)
      return '<img src="/static/waiting.gif"/>'
