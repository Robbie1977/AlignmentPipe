...
stage = {0: 'failed (check settings and restart)',1:'preprocessing', 2:'initial alignment', 3:'affine alignment', 1003:'processing affine alignment', 4:'final warp alignment', 1004:'processing warp alignment', 5:'checking alignment', 6: 'aligning other channels', 7: 'alignment done', 10: 'request merged tif', 20: 'merged tif created'}
