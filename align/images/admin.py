...
class MaskForm(forms.ModelForm):
    cut_objects = system.forms.CSIMultipleChoiceField(choices=((1, 'object labeled 1'), (2, 'object labeled 2'), (3, 'object labeled 3'), (4, 'object labeled 4'), (0, 'background')))
...
class MaskAlignedAdmin(admin.ModelAdmin):
    ...
    def queryset(self, request):
      ...
      return Mask_aligned.objects.filter(Q(__mask_aligned__available=True) | Q(__alignment__user=request.user) | Q(__alignment__user=0))
...
class MaskOriginalAdmin(admin.ModelAdmin):
    ...
    def queryset(self, request):
      ...
      return Mask_original.objects.filter(Q(__mask_aligned__available=True) | Q(__alignment__user=request.user) | Q(__alignment__user=0))
